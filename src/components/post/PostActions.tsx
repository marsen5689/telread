...
/**
 * Post action buttons (comments, share, bookmark)
 */
    ...
    <div class="flex items-center justify-between text-sm text-secondary">
      ...
      <div class="flex items-center gap-4">
        ...
        <button
          ...
          class="flex items-center gap-1.5 hover:text-liquid-500 transition-colors"
        >
      ...
      <div class="flex items-center gap-1">
        ...
        <button
          ...
          class={`
            ...
            ${isBookmarked() ? 'text-liquid-500' : 'hover:text-liquid-500 hover:bg-[var(--glass-bg)]'}
          `}
        ...
        <div class="relative">
          <button
            onClick={handleShare}
            class="p-2 rounded-lg hover:text-liquid-500 hover:bg-[var(--glass-bg)] transition-colors"
            title="Share"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
          ...
          <Show when={showShareToast()}>
            <div class="absolute bottom-full right-0 mb-2 px-3 py-1.5 rounded-lg bg-[var(--color-text)] text-[var(--color-bg)] text-xs whitespace-nowrap animate-fade-in">
              Link copied!
            </div>
          </Show>
        </div>
